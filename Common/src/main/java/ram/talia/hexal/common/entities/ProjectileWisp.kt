...
class ProjectileWisp : BaseWisp {
	...
	constructor(world: Level, pos: Vec3, caster: Player) : super(world, pos, caster)
	constructor(world: Level, pos: Vec3, caster: Player, lifespan: Int) : super(world, pos, caster, lifespan)
